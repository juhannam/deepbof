...
if htk == 1
  ...
  logstep = exp(log(6.4)/27); % the magic 1.0711703 which is the ratio
                              % needed to get from 1000 Hz to 6400 Hz
                              % in 27 steps, and is *almost* the ratio between 1000 Hz and the preceding linear filter center at 933.33333 Hz (actually 1000/933.33333 = 1.07142857142857 and  exp(log(6.4)/27) = 1.07117028749447)
