function [c, posterior] = tagatune_mlp_classify(M, x0, Q0, raw)
%
% slightly modified version of mlp_classify.m in deepmat
%
% mlp_classify
...
if isfield(M, 'dbm') && M.dbm.use
    for l = 2:n_layers
        ...
        if l < n_layers 
            posterior = sigmoid2(posterior, M.hidden.use_tanh);
        end
    end
else
    for l = 2:n_layers
